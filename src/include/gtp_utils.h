...
extern int gtpv2_ie_uli_rewrite(gtp_plmn_t* override_plmn, struct sockaddr_in *, gtp_ie_uli_t *, pkt_buffer_t *);
extern int gtpv2_ie_uli_add(gtp_plmn_t* override_plmn, struct sockaddr_in *, pkt_buffer_t *);
extern int gtpv1_ie_uli_rewrite(gtp_plmn_t* override_plmn, struct sockaddr_in *, gtp1_ie_uli_t *, pkt_buffer_t *);
extern int gtpv1_ie_uli_add(gtp_plmn_t* override_plmn, struct sockaddr_in *, pkt_buffer_t *);
