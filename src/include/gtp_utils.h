...
extern int gtpv2_ie_uli_rewrite(struct sockaddr_in *, gtp_ie_uli_t *, pkt_buffer_t *);
extern int gtpv2_ie_uli_add(struct sockaddr_in *, pkt_buffer_t *);
extern int gtpv1_ie_uli_rewrite(struct sockaddr_in *, gtp1_ie_uli_t *, pkt_buffer_t *);
extern int gtpv1_ie_uli_add(struct sockaddr_in *, pkt_buffer_t *);
