...
#define GTP1C_ECHO_REQUEST				1
#define GTP1C_ECHO_RESPONSE				2
#define GTP1C_VERSION_NOT_SUPPORTED_INDICATION		3
...
#define GTP2C_ECHO_REQUEST				1
#define GTP2C_ECHO_RESPONSE				2
#define GTP2C_VERSION_NOT_SUPPORTED_INDICATION		3
#define GTP2C_CREATE_SESSION_REQUEST			32
#define GTP2C_CREATE_SESSION_RESPONSE			33
#define GTP2C_MODIFY_BEARER_REQUEST			34
#define GTP2C_MODIFY_BEARER_RESPONSE			35
#define GTP2C_DELETE_SESSION_REQUEST			36
#define GTP2C_DELETE_SESSION_RESPONSE			37
...
#define GTPU_ECHO_RSP					2
#define GTPU_ERR_IND					26
#define GTPU_SUPP_EXTHDR_NOTI				31
...
#define GTP1C_ULI_GEOGRAPHIC_LOCATION_TYPE_SAI	(1 << 0)
#define GTP1C_ULI_GEOGRAPHIC_LOCATION_TYPE_RAI	(1 << 1)
